...
static uint32_t vga_ioport_read(void *env, uint32_t addr, uint32_t size)
{
...
static void vga_ioport_write(void *env, uint32_t addr, uint32_t val, uint32_t size)
{
    VGAState *s = &vga_state;
    int index, v;
             ...
             unsigned long vga_ram_offset, int vga_ram_size)
{
    ...
    cpu_register_io_memory(0xa0000, 0x20000, vga_mem_read, vga_mem_write);
